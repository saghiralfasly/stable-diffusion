...
class ImageNetBase(Dataset):
    ...
    def __getitem__(self, i):
        ...
        # print(len(self.data))
        # print(self.data[i] )
        # print("reading sample using getitem ******************")
        return self.data[i]
...
class ImageNetSR(Dataset):
    ...
    def __len__(self):
        # print("len(self.base): ", len(self.base))
        # print("^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^")
...
class ImageNetSRTrain(ImageNetSR):
    ...
    def get_base(self):
        ...
        # convert the length of the data list to the a list of indices 0 to length of the data list [0, 1, 2, 3, ...]
