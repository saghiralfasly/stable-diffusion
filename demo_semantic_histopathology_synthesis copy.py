...
def run():
    ...
    uploaded_image = st.file_uploader("Upload a normal histopathology image", type=["jpg", "jpeg", "png"])
    ...
    # Upload image through Streamlit
    uploaded_image2 = st.file_uploader("Upload a tumor histopathology image", type=["jpg", "jpeg", "png"])
